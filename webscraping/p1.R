...
# look at slide,initial regular expressions
##Top string manipulation functions: - tolower (also toupper, capitalize) - grep - gsub - str_split
#(library: stringr) -substring - paste and paste0 - nchar - str_trim (library: stringr)
#Reading: - http://en.wikibooks.org/wiki/R_Programming/Text_Processing -
#  http://chemicalstatistician.wordpress.com/2014/02/27/
#  useful-functions-in-r-for-manipulating-text-data/ - http://gastonsanchez.com/
 # blog/resources/how-to/2013/09/22/Handling-and-Processing-Strings-in-R.html
...
# By value is true we get value instead of position
# relook at str split function


#Capitalisation
grep("stalin",stalinwords,value=T)
# This implied either capital or small s acceptable
...
grep('\\<d',stalinwords,value=T) # beginning
grep('d\\>',stalinwords,value=T) #end


# Walkthrough3 --------------------------------------
grep('[Aa]mendment',text) # A or a in amendment
